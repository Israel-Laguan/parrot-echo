...
const allowedOrigins = [
  ...
  'http://localhost:3000',
  'http://localhost:3000/',
  'https://parrot-echo-server.herokuapp.com'
]
...
const originUndefined = (req, _, next) => {
  ...
  if (req.headers.host === 'https://parrot-echo-server.herokuapp.com') {
...
module.exports = (app) => {
  ...
  app.use(
    ...
    cors({
      origin: (origin, next) => {
        if (process.env.NODE_ENV !== 'production') return next(null, true)
